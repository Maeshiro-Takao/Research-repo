...
FEATURE_COLS = ["艇","登番","モーター","展示","スタート","勝率","複勝率","1着回数","2着回数","出走回数","優出回数","優勝回数","平均ST","1コース進入回数","1コース複勝率","1コースST","1コースST順位","2コース進入回数","2コース複勝率","2コースST","2コースST順位","3コース進入回数","3コース複勝率","3コースST","3コースST順位","4コース進入回数","4コース複勝率","4コースST","4コースST順位","5コース進入回数","5コース複勝率","5コースST","5コースST順位","6コース進入回数","6コース複勝率","6コースST","6コースST順位"]
TOP_N = 5
...
def load_data(path: Path) -> pd.DataFrame:
    ...
    required = ["開催日","レース","着","艇","登番","モーター","展示","進入","スタート","勝率","複勝率","1着回数","2着回数","出走回数","優出回数","優勝回数","平均ST","1コース進入回数","1コース複勝率","1コースST","1コースST順位","2コース進入回数","2コース複勝率","2コースST","2コースST順位","3コース進入回数","3コース複勝率","3コースST","3コースST順位","4コース進入回数","4コース複勝率","4コースST","4コースST順位","5コース進入回数","5コース複勝率","5コースST","5コースST順位","6コース進入回数","6コース複勝率","6コースST","6コースST順位"] + FEATURE_COLS
